<?php session_start();
    ...
    <?php include_once "include/config.php" ?>
        ...
        <head>
            ...
            <meta name="description" content="dlauto | Car Rental HTML Template from Themescare">
            <meta name="keyword" content="taxi,car,rent,hire,transport">
            <meta name="author" content="Themescare">
            <!-- Title -->
            <title>Driver Less</title>
            <!-- Favicon -->
            <link rel="icon" type="image/png" sizes="32x32" href="assets/img/favicon2.ico">
            <!--Bootstrap css-->
            ...
            <link rel="stylesheet" href="assets/faq/css/style1.css">
